  ...
  return (
    <div className="w-full max-w-5xl mx-auto mb-12 px-4">
      <div className="relative group">
        {/* Main Search Input */}
        <div className="relative z-20 flex items-center bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-slate-100 dark:border-slate-800 rounded-3xl shadow-2xl shadow-indigo-500/10 hover:border-indigo-200 transition-all duration-500 overflow-hidden">
          ...
          <div className="flex items-center gap-2 pr-4">
            ...
            <div className="w-[2px] h-8 bg-slate-100 dark:bg-slate-700 mx-2" />
            <button
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="relative z-10 -mt-6 pt-12 pb-8 px-8 bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-t-0 border-slate-100 dark:border-slate-800 rounded-b-[40px] shadow-xl overflow-hidden"
            >
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all duration-300 border-2 ${
                          category === cat
                            ...
                            : "bg-white dark:bg-slate-800 text-slate-600 dark:text-white border-slate-100 dark:border-slate-700 hover:border-indigo-200"
                        }`}
                      >
                        {cat}
                      </button>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all duration-300 group ${
                          status === item.id
                            ...
                            : "bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-400 dark:text-slate-400 hover:border-indigo-100 hover:text-slate-600 dark:hover:text-white"
                        }`}
                      >
                        <item.icon
              ...
              {/* Reset Footer */}
              <div className="mt-10 pt-6 border-t border-slate-200/50 dark:border-slate-800/50 flex justify-between items-center">
