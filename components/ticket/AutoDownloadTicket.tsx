...
const AutoDownloadLogic = ({ event, booking }: { event: any, booking: any }) => {
    const [instance, updateInstance] = usePDF({ document: <TicketPDF event={event} booking={booking} /> });
    ...
    }, [instance.loading, instance.url, event.title]);
