                ...
                <View style={styles.ticketContainer}>
                        ...
                        <View style={styles.posterSection}>
                            {event?.coverImageUrl ? (
                                ...
                                <View style={styles.posterPlaceholder}>
                                    <Text style={{ fontSize: 8, color: '#94a3b8' }}>NO IMAGE</Text>
                                </View>
                            )}
                        </View>
                        ...
                        <View style={styles.mainContent}>
                            <View>
                                ...
                                <View style={styles.siteLogo}>
                                    <Image src="/logo.png" style={{ height: 50, width: 140, objectFit: 'contain' }} />
                                </View>

                                <Text style={styles.eventTitle}>{event?.title || 'Unknown Event'}</Text>
                                <Text style={styles.eventLocation}>{event?.location || 'Location TBA'}</Text>
                            ...
                            <View style={styles.grid}>
                                ...
                                <View style={styles.col}>
                                    ...
                                    <Text style={{ ...styles.value, fontSize: 8 }}>{booking?.phone || 'N/A'}</Text>
                                </View>
                                <View style={styles.col}>
                                    <Text style={styles.label}>SEATS</Text>
                                    <Text style={styles.value}>{booking?.seats || 1} Reserved</Text>
                                </View>
                                <View style={styles.col}>
                    ...
                    <View style={styles.rightSection}>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <Text style={{ color: '#94a3b8', fontSize: 8, letterSpacing: 2, marginBottom: 5 }}>SCAN TO VERIFY</Text>
                        </View>
                        ...
                        <View style={{ width: '100%', alignItems: 'center' }}>
                            <Text style={{ color: '#64748b', fontSize: 8, marginBottom: 2 }}>SECURITY HASH</Text>
                            <Text style={styles.securityHash}>
                                {booking?._id || 'INVALID-ID'}
                            </Text>
                        </View>

                        <Text style={{ color: 'white', fontSize: 18, fontFamily: 'Helvetica-Bold', marginTop: 10 }}>
