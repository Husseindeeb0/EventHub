            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-slate-50/50">
                {isLoading ? (
                    ...
                    comments.map((comment) => {
                        const isOrganizer = comment.user._id === organizerId;
                        const isMe = currentUserId === comment.user._id;
                        ...
                        return (
                            <div
                                key={comment._id}
                                id={`msg-${comment._id}`}
                                className={`flex gap-3 p-2 rounded-xl transition-colors duration-1000 ${isHighlighted ? "bg-purple-100/50" : ""
                                ...
                                >
                                    ...
                                    <div className="relative group">
                                        ...
                                        <button
                                            ...
                                            className={`absolute -bottom-3 ${isMe ? "-left-2" : "-right-2"
                                                } bg-white rounded-full p-1 shadow-sm border border-slate-100 flex items-center gap-1 hover:scale-110 transition-transform ${isLiked ? "text-red-500" : "text-slate-400"
                                                }`}
                                        ...
                                        <div
                                            className={`absolute top-1/2 -translate-y-1/2 ${isMe ? "-left-20" : "-right-20"
                                        ...
                                        >
                                            ...
                                            {canPin && (
                                                <button
                                                    ...
                                                    className={`p-1.5 transition-colors rounded-full hover:bg-amber-50 ${comment.isPinned
                                                ...
                                                >
                                                    <Pin
                                                        className={`w-3.5 h-3.5 ${comment.isPinned ? "fill-current" : ""
                                                            }`}
                                                    />
                                                </button>
                                            )}
