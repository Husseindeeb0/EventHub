              ...
              <>
                {userRating ? (
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-linear-to-r from-amber-400 to-orange-500 text-white text-[11px] font-black uppercase tracking-widest hover:shadow-lg hover:shadow-amber-500/20 active:scale-95 transition-all cursor-pointer"
                  >
