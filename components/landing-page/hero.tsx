            ...
            <div className="container px-4 md:px-6 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-[600px] font-light">
                        The all-in-one platform to find your next experience or manage your own events with ease.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto pt-6">
                        <Button size="lg" className="h-16 px-10 text-lg rounded-full bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-200 hover:shadow-2xl hover:shadow-indigo-300 transition-all hover:-translate-y-1">
                            Explore Events
                        </Button>
                    ...
                    <div className="relative w-full max-w-[600px] aspect-[4/5] md:aspect-square">
                        ...
                        <div className="relative h-full w-full bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden flex flex-col transform transition-transform hover:scale-[1.02] duration-500">
                            ...
                            <div className="p-8 border-b border-gray-50 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold text-xl">EH</div>
                                    <div>
                                        <div className="font-bold text-gray-900">EventHub Dashboard</div>
                            ...
                            <div className="flex-1 p-8 bg-gray-50/50 space-y-6">
                                ...
                                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                                    <div className="flex justify-between items-end mb-4">
                                        ...
                                        <div className="text-green-500 font-medium bg-green-50 px-3 py-1 rounded-full text-sm">+12.5%</div>
                                    </div>
                                    <div className="h-32 flex items-end gap-2">
                                        {[40, 70, 45, 90, 65, 85, 55].map((h, i) => (
                                            <div key={i} className="flex-1 bg-indigo-100 rounded-t-lg relative group overflow-hidden">
                                                <div
                                ...
                                <div className="space-y-3">
                                    {[1, 2].map((i) => (
                                        <div key={i} className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${i === 1 ? 'bg-purple-100 text-purple-600' : 'bg-blue-100 text-blue-600'}`}>
                                                {i === 1 ? '🎉' : '🎫'}
                                            </div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-sm font-bold text-gray-900">Sold Out!</span>
                            </div>
                            <p className="text-xs text-muted-foreground">Your event "Tech Summit 2025" just reached capacity.</p>
                        </motion.div>
