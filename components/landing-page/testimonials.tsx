...
const testimonials = [
    {
        quote: "EventHub transformed how we manage our annual tech conference. The analytics alone saved us countless hours of manual tracking.",
        author: "Sarah Chen",
        role: "Event Director",
    ...
    {
        quote: "We've hosted over 200 community meetups using EventHub. The platform is intuitive, reliable, and our attendees love the seamless experience.",
    ...
    {
        quote: "The custom branding features let us maintain our identity while leveraging EventHub's powerful infrastructure. It's the best of both worlds.",
