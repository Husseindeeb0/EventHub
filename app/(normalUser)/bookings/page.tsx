...
const BookingCard: React.FC<{ event: BookedEvent }> = ({ event }) => {
    const { title, date, time, location, seatsBooked, capacity, posterUrl } = event;
    ...
    return (
        ...
        ${isPast ? 'opacity-60 grayscale' : 'hover:shadow-2xl hover:scale-[1.01]'} border border-gray-100`}
        >
            ...
            <div className="p-6 flex-grow flex flex-col justify-between">
                <div>
                    <h3 className={`text-2xl font-bold mb-2 ${isPast ? 'text-gray-600' : 'text-indigo-800'}`}>
                        {title}
                    </h3>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <section className="mb-12">
                    ...
                    {upcomingBookings.length > 0 ? (
                        ...
                        <div className="bg-white p-6 rounded-xl text-center text-gray-500 border border-dashed border-gray-300">
                            ...
                            <p className="text-lg font-medium">You have no upcoming events booked.</p>
                            <p className="mt-1">Head over to the <a href="/home" className="text-indigo-600 hover:text-indigo-800 font-semibold">Home Page</a> to find something exciting!</p>
                        </div>
                    )}
                </section>
                ...
                <section>
                    ...
                    {pastBookings.length > 0 ? (
                        ...
                        <div className="bg-white p-6 rounded-xl text-center text-gray-500 border border-dashed border-gray-300">
                            <p className="text-lg font-medium">Once you attend an event, it will appear here.</p>
                        </div>
                    )}
                </section>
