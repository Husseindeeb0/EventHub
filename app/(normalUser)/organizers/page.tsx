        ...
        <AnimatedPageHeader>
          <header className="relative mb-12 text-center sm:text-left">
            <div className="flex flex-col gap-3 relative z-10">
              <span className="inline-flex w-fit mx-auto sm:mx-0 items-center rounded-full bg-indigo-50 dark:bg-indigo-900/30 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-800">
                Community Leaders
              </span>
              <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white sm:text-5xl leading-tight">
                Featured Organizers
              </h1>
              <p className="text-sm sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl">
